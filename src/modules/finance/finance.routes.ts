...
financeRoutes.post("/finance/credit-loan-interest", FinanceController.createManualLoanInterestTransaction);
financeRoutes.post("/finance/close-loan", FinanceController.closeLoanTransaction);
